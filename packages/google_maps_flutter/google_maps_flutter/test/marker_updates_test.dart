...
void main() {
  ...
  testWidgets('Updating a marker', (WidgetTester tester) async {
    ...
    expect(update.alpha, equals(0.5));
  });
  ...
  testWidgets('Multi Update', (WidgetTester tester) async {
    ...
    m2 = const Marker(markerId: MarkerId('marker_2'), consumeTapEvents: true);
  ...
  testWidgets('Partial Update', (WidgetTester tester) async {
    ...
    m3 = const Marker(markerId: MarkerId('marker_3'), consumeTapEvents: true);
